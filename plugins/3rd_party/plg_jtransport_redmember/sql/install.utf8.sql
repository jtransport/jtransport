...
INSERT INTO `#__redmember_user_statuses` (`status_id`, `status_name`) VALUES
(3, 'COM_REDMEMBER_APPROVED'),
(4, 'COM_REDMEMBER_PENDING'),
(5, 'COM_REDMEMBER_REJECTED'),
(6, 'COM_REDMEMBER_DEACTIVATED'),
(7, 'COM_REDMEMBER_EXCLUDED'),
(9, 'COM_REDMEMBER_BLOCKED');
