...
class JTransportVirtuemartCategory extends JTransport
{
    ...
    public function insertIntoMedias($rows)
    {
        ...
        foreach ($rows as &$row)
        {
            ...
            $oldMediaDir = JPATH_ADMINISTRATOR . '/components/com_jtransport/includes/media/joomla15/shop_image/category';
