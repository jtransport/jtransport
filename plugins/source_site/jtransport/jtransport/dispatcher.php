...
class JTransportDispatcher
{
	...
	public function execute($parameters)
	{
		...
		elseif ($task == 'row')
		{
			...
			$order = $this->_parameters['HTTP_ORDER'];

			$result = $this->_getRow($table, $order, $start, $limit);
		}
	 ...
	 * @return mixed|string
	 */
	protected function _getRow($table, $order, $start, $limit)
	{
		$db = JFactory::getDbo();
